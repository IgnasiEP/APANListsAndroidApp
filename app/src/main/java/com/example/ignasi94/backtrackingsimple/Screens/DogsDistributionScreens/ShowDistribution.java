...
public class ShowDistribution extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = (ImageView) findViewById(R.id.image_cage_map);

        //new Large_ImagePopup(this,"my image url link");

        Dialog settingsDialog = new Dialog(this);
        settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        Display d = ((Activity) this).getWindowManager().getDefaultDisplay();
        int w = d.getWidth();
        int h = d.getHeight();
        settingsDialog.getWindow().setLayout((int)( w/100)*100, (int)( h/100)*70);
        settingsDialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
        settingsDialog.setContentView(R.layout.distribution_map_popup);
        settingsDialog.show();
    ...
    public class Large_ImagePopup extends Dialog {
        ...
        public Large_ImagePopup(Context context,String imageurl) {
            ...
            setContentView(R.layout.distribution_map_popup);
            ...
            getWindow().setLayout((int)( w/100)*100, (int)( h/100)*70);
            getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
            setCancelable(true);

            //now get imageview inside custome dialog layout
            ImageView large = (ImageView) findViewById(R.id.image_cage_map);
